    ...
    <?php if ($header): ?>
        <section class="section-image position-relative">
            <?php if (is_front_page()) : ?>
                <img src="<?php bloginfo('template_url'); ?>/images/video-fallback-image.jpg" alt="<?php echo esc_attr($banner_img['alt']); ?>"
                     class="img-fluid object-fit-cover d-lg-none" aria-hidden="true">
                <video autoplay muted loop id="background-video" poster="<?php bloginfo('template_url'); ?>/images/video-fallback-image.jpg" class="d-none d-lg-block">
            ...
            <div class="container header-container position-absolute z-index-10 w-100 h-100">
                <div class="row justify-content-center text-center h-100">
                    <div class="col-lg-10">
                        <div class="top-content d-flex flex-column align-content-center justify-content-center h-100 pt-lg-1 pt-lg-3"
                             data-aos="zoom-out"
                             data-aos-offset="0"
                             data-aos-delay="0"
